...
public class ProductosDao {
    ...
    public boolean RegistrarProductos(Productos pro) {
        String sql = "INSERT INTO productos (codigo, nombre, proveedor, cantidad, precio)"
                + "VALUES(?,?,?,?,?)";
        try {
    ...
    public boolean ModificarProductos(Productos pro) {
        ...
        String sql = "UPDATE productos SET codigo=?, nombre=?, proveedor=?, cantidad=?, precio=? "
                + "WHERE id=?";
        try {
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
    ...
    public Productos BuscarPro(String cod){
        ...
        String sql = "UPDATE config SET dni=?, nombre=?, telefonor=?, direccion=?, razon=? "
                + "WHERE id=?";
        try {
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
